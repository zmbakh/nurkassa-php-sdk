...
class RequestBodyMultipart implements NurkassaBodyInterface
{
    /**
     ...
     * @return string
     */
    private function getFileString($name, NurkassaFile $file)
    {
        return sprintf(
     ...
     * @return string
     */
    protected function getFileHeaders(NurkassaFile $file)
    {
